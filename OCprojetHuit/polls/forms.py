...
class SignIt(forms.Form):
	...
	pass_first = forms.CharField(label='Votre mot de passe', widget=forms.PasswordInput, max_length=100, validators=[RegexValidator(regex="([a-zA-Z]){4,12}([0-9]){2,12}",message="Mot de passe invalide")])
...
class Search(forms.Form)
	search = forms.CharField(widget=forms.TextInpyt(attrs={'placeholder':'Chercher'}))
